...
Name:
-------------------------------------
This program replaces the green screen background of jerry.
jpeg with wave.jpeg.

By detecting green pixels and substituting them
with pixels from another image, students will gain
intuition about basic Photoshop-style image editing techniques.
"""
...
def main():
    ...
    bg = SimpleImage('images/leaves.png')
